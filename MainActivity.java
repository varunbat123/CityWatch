...
Intent restart = new Intent(MainActivity.this,MainActivity.class);
                    ...
                    final String e = user.getText().toString();
//Check if fields are filled
if (e.equals("")){
    Toast.makeText(MainActivity.this," Email cannot be blank",Toast.LENGTH_LONG).show();
    startActivity(restart);
    return;
}
if (p.equals("")){
    Toast.makeText(MainActivity.this," Password cannot be blank",Toast.LENGTH_LONG).show();
    startActivity(restart);
    return;
}
if (n.equals("")){
...
if (s.equals("" )) {
    Toast.makeText(MainActivity.this," Username cannot be blank",Toast.LENGTH_LONG).show();
    startActivity(restart);
    return;
}
